...
int main(){
	...
	cout<<"\n\nMatriz B: ";
	vect2 = matriz.crearMatriz(matriz.getFilas(),matriz.getColumnas());
	matriz.encerar(vect2,matriz.getFilas());
	matriz.ingresarDatosMatriz(vect2,matriz.getFilas());
	matriz.imprimir(vect2,matriz.getFilas());
